...
(function (global, factory) {
  ...
  var MIN_CONTAINER_WIDTH = 1200;
  var MIN_CONTAINER_HEIGHT = 1000;
  ...
  var preview = {
    initPreview: function initPreview() {
      ...
      forEach(previews, function (el) {
        ...
        img.style.cssText = 'display:block;' + 'width:auto;' + 'height:auto;' + 'min-width:0!important;' + 'min-height:0!important;' + 'max-width:none!important;' + 'max-height:none!important;' + 'image-orientation:0deg!important;"';
        el.innerHTML = '';
        el.appendChild(img);
      });
    },
